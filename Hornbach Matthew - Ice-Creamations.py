...
window2=tk.Toplevel()
window2.title("Order Report")
window2.geometry("400x300+1000+300")
...
orderButton.place(relx=.35, rely=.5, relwidth=.3, relheight=.3)

#Creates the text box where the order will go
orderReport = tk.Text(window2, height = 12, width = 30, bg = "#FFFF99", state = "disabled")
orderReport.place(relx=.05, rely=.05, relwidth=.9, relheight=.8)
orderReport.config(state=tk.NORMAL)
...
exitButton = tk.Button(frame, command = window.destroy, text = "Exit", relief = 'solid', bg = "#FC2121", fg = "black", activebackground = "black", activeforeground = "white")
exitButton.place(relx=.425, rely=.85, relwidth=.15, relheight=.1)

"""Start of dish portion"""

#Makes a label that shows you what dishware you can choose
dishwareLabel = tk.Label(frame, text="Dish", relief = 'solid', fg = "black", bg = "#787878")
...
scoopsLabel = tk.Label(frame, text="Scoops", relief = 'solid', fg = "black", bg = "#787878")
...
flavorLabel = tk.Label(frame, text="Flavor", relief = 'solid', fg = "black", bg = "#787878")
flavorLabel.place(relx = .4, rely = 0, relwidth = 0.15, relheight = 0.1)
...
toppingsLabel = tk.Label(frame, text="Toppings", relief = 'solid', fg = "black", bg = "#787878")
...
noToppings = tk.Radiobutton(frame, text = "No Toppings", relief = 'solid',  bg = "white", fg = "black", activebackground = "black", activeforeground = "white", value="No Toppings",variable= t)
noToppings.place(relx = .8, rely = 0.3, relwidth = 0.2, relheight = 0.1)
